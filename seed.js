...
const PendingApproval = require('./backend/models/PendingApproval');
const AgentActionLog = require('./backend/models/AgentActionLog');
...
const seedData = async () => {
  try {
    ...
    await AgentActionLog.deleteMany();
    ...
    const admin = await User.create({
      ...
      password: 'Demo1234!', // plain text, pre-save hook hashes it
      role: 'admin',
    });
    ...
    const sampleProducts = [
      ...
      },
      {
        ...
        images: [{ url: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800', alt: 'Duffel Bag' }],
        rating: 4.5,
        numReviews: 118,
        isFeatured: false,
        createdBy: admin._id,
      },
      {
        ...
        images: [{ url: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=800', alt: 'Book Cover' }],
        rating: 4.8,
        numReviews: 450,
        isFeatured: true,
        createdBy: admin._id,
      },
      {
        ...
        images: [{ url: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=800', alt: 'Clutch' }],
        rating: 4.6,
        numReviews: 95,
        isFeatured: false,
        createdBy: admin._id,
      },
      {
        ...
        stock: 100,
        thumbnail: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800',
        images: [{ url: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800', alt: 'Beach Tote' }],
        rating: 4.4,
        numReviews: 78,
        isFeatured: false,
        createdBy: admin._id,
      ...
      },
      {
        ...
        images: [{ url: 'https://images.unsplash.com/photo-1519710164239-da123dc03ef4?w=800', alt: 'Night Lamp' }],
        rating: 4.3,
        numReviews: 64,
        isFeatured: false,
        createdBy: admin._id,
      },
      {
        ...
        images: [{ url: 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=800', alt: 'TV' }],
        rating: 4.6,
        numReviews: 180,
        isFeatured: true,
        createdBy: admin._id,
      },
      {
        ...
        images: [{ url: 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=800', alt: 'Shirt' }],
        rating: 4.4,
        numReviews: 95,
        isFeatured: false,
        createdBy: admin._id,
      },
      {
        ...
        images: [{ url: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=800', alt: 'Sneakers' }],
        rating: 4.5,
        numReviews: 132,
        isFeatured: false,
        createdBy: admin._id,
      },
      {
        ...
        images: [{ url: 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=800', alt: 'Coffee Table' }],
        rating: 4.6,
        numReviews: 78,
        isFeatured: true,
        createdBy: admin._id,
    ...
    // ── Create a DELIVERED order for the Agent Demo ───────────────────────
    // Pick the first product for the demo order
    const demoProduct = insertedProducts[0];
    ...
    const order = await Order.create({
      ...
      orderItems: [
        {
          ...
          image: demoProduct.images[0]?.url || demoProduct.thumbnail,
        },
      ],
      shippingAddress: {
      ...
      paymentMethod: 'Card',
      itemsPrice: demoProduct.price,
      taxPrice: 4500,
      shippingPrice: 0,
      totalPrice: demoProduct.price + 4500,
    ...
    await Payment.create({
      ...
      cardDetails: { last4Digits: '4242', cardType: 'Visa', expiryMonth: 12, expiryYear: 2026 },
    });
    ...
    console.log('=================================');
    console.log('\nDemo User Login:');
    console.log('Email: demo@buyeasy.com');
    console.log('Password: Demo1234!');
    console.log('\nAdmin Login:');
    console.log('Email: admin@buyeasy.com');
    console.log('Password: Demo1234!');
    console.log('=================================\n');
    console.log('✅ Demo order created for chat agent:');
    console.log(`   Order ID: ${order._id}`);
    console.log(`   Status: Delivered (${deliveredAt.toDateString()})`);
    console.log(`   Total:  ₹${order.totalPrice}`);
    console.log('\n📋 Use this Order ID in the chat widget demo.\n');
